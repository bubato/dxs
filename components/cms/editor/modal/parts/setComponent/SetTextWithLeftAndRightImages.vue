<template>
  <div class="set-text-with-left-and-right-images">
    ...
    >
      ...
      <div class="select-image">
        <div class="flex flex-between">
          ...
          <SelectImageAlign
            :value="imageInfo.imageAlign"
            @selectImageAlign="selectImageAlign($event, index)"
          />
        </div>
        <SelectImageFile
...
export default {
  name: 'SetTextWithLeftAndRightImages',
  props: {
  ...
  methods: {
    ...
    selectImageAlign(selectVal, index) {
      this.component.images[index].imageAlign = selectVal
    },
    addBlock() {
...
.set-text-with-left-and-right-images {
  width: 640px;
