      ...
      >
        <div class="modal-container">
          ...
          <div class="modal_title">
            ...
            <h4>保存したシミュレーションの削除</h4>
          </div>
          <div class="modal_contents">
            <p class="context">
              選択したシミュレーションを削除しますか?<br />
              一度削除したシミュレーションは元に戻せません。
            </p>
            <div class="buttons">
              <button
...
export default {
  ...
  computed: {
    ...mapState('community/message', ['selectMessage']),
  },
  created() {},
  methods: {
    /**
    ...
    deleteSimulation() {
      const params = {
        simulationResultId: this.simulationInfo.simulationResultId,
        recordVersion: this.simulationInfo.recordVersion,
      }

      this.$common.addCallApiNum()
      this.$api
        .deleteSimulation(params)
        .then((resData) => {
