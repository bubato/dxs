      ...
      >
        <div class="modal-container">
          ...
          <div class="modal_contents">
            <div class="input-tag">
              <CustomInputText v-model="formTagContext" :is-disabled="true" />
              <button
...
export default {
  ...
  methods: {
     ...
     */
    setFormTagContext() {
      this.formTagContext = this.selectFormInfo.scriptTag
    },
    /**
     * クリップボードにコピー
     */
    copyClipBoard() {
      this.$common.copyClipBoard(this.formTagContext)
