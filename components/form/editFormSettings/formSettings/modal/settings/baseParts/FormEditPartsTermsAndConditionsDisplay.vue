<template>
  <div class="edit-area">
    <div class="form-block">
      <p class="margin-b-32">
        規約表示パーツは必須項目となります。<br />
        チェックボックスを選択しないと送信ボタンがクリックできません。
      </p>
      <div class="form-item">
    ...
    <div class="form-block">
      ...
      <div class="form-item">
        ...
        <CustomInputText
          v-model="partsData.parts_attr.label"
          maxlength="100"
          placeholder="ラベルを入力してください"
          :validation="
            $common.getFormItemsDetail(formItems, 'label').validation
          "
          @input="checkValidation()"
        />
      </div>
...
export default {
  name: 'FormEditPartsTermsAndConditionsDisplay',
  components: {},
  props: {
    partsData: {
      type: Object,
  ...
  methods: {
    ...
    checkValidation() {
      ...
      const validationItems = {
        ...
        label: this.partsData.parts_attr.label,
