<template>
  <div class="edit-area">
    <div class="form-block">
      <div class="form-item">
        <RequiredFormLabel class="title" label="テキスト" :required="true" />
        <p class="sub-text">HTML入力可</p>
        <CustomInputTextarea
          v-model="partsData.parts_attr.text"
      ...
      <div class="form-item">
        <p class="title">配置</p>
        <CustomInputRadio
          v-model="partsData.parts_attr.arrangement"
...
import { ARRANGEMENT_OPTIONS } from '~/assets/js/form/f-6m-constants'

export default {
  name: 'FormEditPartsText',
  props: {
    partsData: {
      type: Object,
      default: () => {},
  ...
  methods: {
    ...
    checkValidation() {
      ...
      const validationItems = {
        text: this.partsData.parts_attr.text,
